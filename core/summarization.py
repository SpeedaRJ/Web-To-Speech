...
SUMMARIZE_MODEL_NAME = "google/pegasus-cnn_dailymail"
...
class TextSummarizer:
    ...
    def summarize(self, text: str) -> str:
        ...
        summary = self.summarizer(text, max_length=self.max_length,
                                  min_length=self.min_length, do_sample=False, truncation=True)[0]["summary_text"]
